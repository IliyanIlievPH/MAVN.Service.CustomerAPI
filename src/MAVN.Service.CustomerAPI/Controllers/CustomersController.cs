...
using PasswordResetError = Lykke.Service.CustomerManagement.Client.Enums.PasswordResetError;
using RegistrationRequestModel = MAVN.Service.CustomerAPI.Models.Customers.RegistrationRequestModel;
using ResetIdentifierValidationRequest = Lykke.Service.CustomerManagement.Client.Models.Requests.ResetIdentifierValidationRequest;
