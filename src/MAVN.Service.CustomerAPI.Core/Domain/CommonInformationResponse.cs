namespace MAVN.Service.CustomerAPI.Core.Domain
{
    public class CommonInformationResponse
    {
        ...
        /// <summary>
        /// Represents information for android app download link
        /// </summary>
        public string DownloadAndroidAppLink { get; set; }

        /// <summary>
        /// Represents information for iso app download link
        /// </summary>
        public string DownloadIsoAppLink { get; set; }

        /// <summary>
        /// Represents information for support's email address
        /// </summary>
